...
from neural_methods.model.PhysNetEllie import PhysNet_padding_Encoder_Decoder_MAX_Ellie
from neural_methods.model.PhysNetEllie import AppearanceBranch
...
class PhysnetTrainerEllie(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        self.model = PhysNet_padding_Encoder_Decoder_MAX_Ellie(
            frames=config.MODEL.PHYSNET.FRAME_NUM).to(self.device)  # [3, T, 128,128]
